...
data:extend({
    {
                ...
                action = {
                    ...
                    action_delivery = {
                        ...
                        source_effects =
                        {
                            {
                                type = "script",
                                effect_id = ERM_TERRAN.SELF_DESTRUCT_ATTACK,
                            },
                            {
                                type = "create-entity",
                                entity_name =  ERM_TERRAN.MOD_NAME.."--spidermine-explosion"
                            }
                        },
                        target_effects = {
                            {
        ...
        created_effect = {
            ...
            action_delivery = {
                ...
                source_effects = {
                    {
                        type = "script",
                        effect_id = ERM_TERRAN.TIME_TO_LIVE_CREATED,
                    }
                }
            }
        },
        dying_trigger_effect = {
            {
                type = "script",
                effect_id = ERM_TERRAN.TIME_TO_LIVE_DIED,
            }
        },
        dying_explosion = ERM_TERRAN.MOD_NAME.."--spidermine-explosion",
